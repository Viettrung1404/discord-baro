...
CREATE TABLE "Channel" (
    ...
    "allowedRoles" "MemberRole"[] DEFAULT ARRAY['ADMIN', 'MODERATOR', 'GUEST']::"MemberRole"[],
    "profileId" TEXT NOT NULL,
    "serverId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ChannelPermission_channelId_memberId_key" ON "ChannelPermission"("channelId", "memberId");
...
-- AddForeignKey
ALTER TABLE "ChannelPermission" ADD CONSTRAINT "ChannelPermission_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;
