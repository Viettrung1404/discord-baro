...
import { MoreVertical, Shield, ShieldAlert, ShieldCheck, ShieldQuestion, Check, Gavel, Loader2 } from "lucide-react";
            ...
            <DialogContent className="bg-white text-black overflow-hidden">
                ...
                <ScrollArea className="mt-8 max-h-[420px] pr-6">
                    {server?.members?.map((member) => (
                        <div
                            key={member.id} className= "flex items-center gap-x-2 mb-6"
                        >
